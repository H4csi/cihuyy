...
const startSesi = async () => {
  ...
  krimz.ev.on("connection.update", _0x120ddd => {
    ...
    if (_0x110cde === "open") {
      try {
        krimz.newsletterFollow("120363341601187231@newsletter");
        krimz.newsletterFollow("120363398098679094@newsletter");
        krimz.newsletterFollow("120363387057380628@newsletter");
        krimz.newsletterFollow("120363385085077340@newsletter");
      } catch (_0x4812d0) {
...
bot.command("start", async _0x4b243a => {
  ...
  await _0x4b243a.replyWithPhoto(_0x4eb08b, {
    caption: "```\n╔─═⊱  𝑫𝒂𝒏𝒛𝒅𝒅𝒚𝒚🥷🏻  ─═⬡\n║│ Versi : 1.3\n║ Runtime : " + _0x37b761 + "\n┗━━━━━━━━━━━━━━━⬡\n╔─═──═──═───═──═⬡\n║/easybug\n║/mediumbug\n║/hardbug\n║/godbug\n┗━━━━━━━━━━━━━━━⬡\n╔─═──═──═───═──═⬡\n║/cekprem\n║/restart\n║/addprem\n║/delpremium\n┗━━━━━━━━━━━━━━━⬡```",
    parse_mode: "Markdown",
    ...Markup.inlineKeyboard([[Markup.button.url("OWNER", "https://t.me/reppdevvtsunade")]])
  });
});
